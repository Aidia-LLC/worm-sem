...
import { validateAngles } from "./validateAngles";

export const validateTrapezoid = ({
  trapezoid,
  x,
  y,
  options,
  ...
  const angles = validateAngles(trapezoid);
  ...
  return areaValid && fitValid && sideValid && centerPointValid;
};
